...
"""
ARRIVAL_RATES = [0.001, 0.005, 0.01, 0.02, 0.03, 0.05, 0.1, 0.25, 0.5, 1]  # average incoming requests per millisecond
MAX_QUEUE_SIZES = [10, 50, 100, 500, 1000, 2000, 5000, 10000][::-1]
